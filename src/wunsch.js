...
export function erstelleWunsch(felder = {}) {
  ...
  return {
    ...
    paketKonfiguration: Array.isArray(felder.paketKonfiguration) ? felder.paketKonfiguration : [],
...
export function normalizeWunsch(w = {}) {
  ...
  return {
    ...
    paketKonfiguration: Array.isArray(w.paketKonfiguration) ? w.paketKonfiguration : [],
